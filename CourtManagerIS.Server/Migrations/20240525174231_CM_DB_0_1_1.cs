...
{
    /// <inheritdoc />
    public partial class CM_DB_0_1_1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeriePassport = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    NumberPassport = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Privilege = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordAttempts = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Employees_CreatedEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityHistory_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_CreatedEmployeeId",
                table: "Events",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ActivityHistory_Employees_EmployeeId",
                table: "ActivityHistory",
                column: "EmployeeId",
                principalTable: "Employees",
                principalColumn: "Id",
